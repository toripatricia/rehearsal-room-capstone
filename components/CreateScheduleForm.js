...
CreateScheduleForm.propTypes = {
  obj: PropTypes.shape({
    ...
    eventOneName: PropTypes.string,
    eventOneMembers: PropTypes.string,
    eventTwoName: PropTypes.string,
    eventTwoMembers: PropTypes.string,
    eventThreeName: PropTypes.string,
    eventThreeMembers: PropTypes.string,
    eventFourName: PropTypes.string,
    eventFourMembers: PropTypes.string,
    eventFiveName: PropTypes.string,
    eventFiveMembers: PropTypes.string,
    eventSixName: PropTypes.string,
    eventSixMembers: PropTypes.string,
